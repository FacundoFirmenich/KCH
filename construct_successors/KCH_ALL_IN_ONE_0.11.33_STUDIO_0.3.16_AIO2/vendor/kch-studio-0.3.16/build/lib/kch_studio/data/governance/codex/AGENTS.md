...
## [HARNESS] KCH-HARNESS — KCH integral self-governance harness
...
## [AGENTS] KCH-AGENTS — KCH sovereign and coral agent topology
...
## [AGENT] AGENT-CONSTITUTIONAL-LOCK-GOVERNOR — Constitutional lock governor

Authority ceiling: BUILD_STAGED, DESIGN, INSPECT, RECOMMEND, VALIDATE.
...
## [AGENT] AGENT-CORAL-INTEGRATION-AUDITOR — Coral strategic integration auditor
...
## [AGENT] AGENT-EVIDENCE-SKILL-CONTINUITY — Evidence-derived learning, skill and continuity curator
...
## [RULES] KCH-RULES — KCH semantic rules, routines and subroutines
...
## [RULE] RULE-ALL-STRATEGIC-CORAL-INTEGRATION — Every KCH element is strategic and must integrate chorally
...
## [RULE] RULE-CONSTITUTIONAL-LOCK-KEYS — Exact constitutional lock keys
...
## [RULE] RULE-EVIDENCE-DERIVED-SKILL-LIFECYCLE — Evidence-derived protocol, skill and continuity lifecycle
...
## [RULE] RULE-EVIDENCE-PRESERVING-CLOSURE — Evidence-preserving mechanical closure
...
## [RULE] RULE-RESPONSE-MODES-SUBSTANTIVE — Substantive authored-chat response modes

Authority ceiling: DESIGN, INSPECT, RECOMMEND.
