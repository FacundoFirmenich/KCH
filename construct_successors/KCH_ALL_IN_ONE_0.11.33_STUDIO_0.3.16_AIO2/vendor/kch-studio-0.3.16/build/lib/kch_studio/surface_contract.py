...
STRATEGIC_SURFACE_CONTRACT: dict[str, dict[str, str]] = {
    ...
    "kch_studio.construct_mode:ConstructMode": {
        ...
        "propose_write": "construct_file_write_propose",
    ...
    "kch_studio.lock_governor:LockGovernor": {
        "connect": "INTERNAL:SQLITE_CONNECTION_FACTORY",
        "enabled": "lock_governor_status",
        "set_enabled": "INTERNAL:TRUSTED_LOCAL_USER_UI_NOT_MCP",
        "create_lock": "INTERNAL:TRUSTED_LOCAL_USER_UI_NOT_MCP",
        "deactivate_lock": "INTERNAL:TRUSTED_LOCAL_USER_UI_NOT_MCP",
        "locks": "lock_list",
        "matching_locks": "INTERNAL:LOCK_MATCHING_PRIMITIVE",
        "preflight": "INTERNAL:FAIL_CLOSED_MUTATION_INTERPOSITION",
        "propose": "lock_change_propose",
        "pending_proposals": "lock_pending_proposals",
        "trusted_authorize": "INTERNAL:TRUSTED_LOCAL_USER_UI_NOT_MCP",
        "authorization_status": "lock_authorization_status",
        "verify_drift": "lock_drift_verify",
        "verify": "INTERNAL:LOCK_HASH_CHAIN_VERIFY",
        "status": "lock_governor_status",
    },
    ...
    "kch_studio.evidence_projection:EvidencePreservingClosure": {
        "materialize": "evidence_closure_materialize",
        "verify": "evidence_closure_verify",
    },
