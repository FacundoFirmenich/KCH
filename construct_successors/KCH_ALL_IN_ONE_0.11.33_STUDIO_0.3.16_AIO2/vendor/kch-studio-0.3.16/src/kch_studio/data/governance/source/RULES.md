...
parent = "KCH-AGENTS"
children = ["RULE-ALL-STRATEGIC-CORAL-INTEGRATION", "RULE-AUTHORITY-NONESCALATION", "RULE-CONSTITUTIONAL-LOCK-KEYS", "RULE-EVIDENCE-DERIVED-SKILL-LIFECYCLE", "RULE-FULL-READ-SOURCE-ORDER", "RULE-GENERATION-STAGED", "RULE-EXTENSION-ACQUISITION", "RULE-RECOMMENDATION-EVIDENCE", "RULE-INTERFACE-TRANSPARENCY", "RULE-RESPONSE-MODES-SUBSTANTIVE", "RULE-HOST-PROJECTION", "RULE-TERMINAL-PROCESS-SUPERVISION", "RULE-EVIDENCE-PRESERVING-CLOSURE"]
