...
SKILL_CREATOR = Path(
    os.environ.get("KCH_SKILL_CREATOR_ROOT", r"C:\Users\User\.codex\skills\.system\skill-creator")
)
PLUGIN_CREATOR = Path(
    os.environ.get("KCH_PLUGIN_CREATOR_ROOT", r"C:\Users\User\.codex\skills\.system\plugin-creator")
)
